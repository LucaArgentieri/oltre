  ...
  <div class="shop">
    <div class="main">
      ...
      <div class="full-img">
        ...
        <label class="lato light" for="">Lascia un commento</label>
        <input class="lato light h6" type="text" />
      </div>
    </div>
    <div class="desc">
      <div class="info">
        <p class="title grandslang h2">Microscopic Mini G Vibrator Pink</p>
        <p class="text lato light h5 c-black">
          ...
          appositamente studiato per la stimolazione CUV (clito-uretro-vaginale)
          e gli orgasmi femminili.
        </p>
        <br />
        <span class="flex price">
          <p class="medium h4">23.90€</p>
        </span>
      </div>

      <div class="input">
        <label class="lato light italic" for=""
          >Inserisci il codice sconto</label
        >
        <input class="lato light h5" type="text" />
      </div>
    </div>
  </div>
  <Footer />
